...
# functions for tracking vehicles
...
def draw_boxes(img, bbox, start_area, stop_area, weights, identities=None, categories=None, names=None, offset=(0, 0)):
    area1_pointA = start_area[3]
    area1_pointB = start_area[2]
    area1_pointC = stop_area[3]
    area1_pointD = stop_area[2]
    ...
    for i, box in enumerate(bbox):
        ...
        #check if object on in the start_area or stop_area box
        ...
        if id not in vehicles_entering:
            if in_on_start_area >= 0:
                vehicles_entering[id] = [FROM_START, time.time()]
            elif in_on_stop_area >= 0:
                vehicles_entering[id] = [FROM_STOP, time.time()]

        if id in vehicles_entering:
            if in_on_stop_area >= 0 and vehicles_entering[id][0] == FROM_START or in_on_start_area >= 0 and vehicles_entering[id][0] == FROM_STOP:
                elapsed_time = time.time() - vehicles_entering[id][1]
                ...
                cv2.putText(img, "Speed "+str(int(a_speed_kh))+" km/h", (x1, y1 - 5),cv2.FONT_HERSHEY_DUPLEX, 0.6, [255, 255, 255], 1)
...
def detect(save_img=False):
    ...
    source.replace('/content/gdrive/MyDrive/RM Paper/YOLOv7-model/yolov7/source/', '')
    print(weights)
    
    if source == 'source/Jl. A. Yani Utara.mkv':
        start_area = [(0, 200), (1280, 200), (1280, 250), (0, 250)]
        stop_area = [(0, 500), (1280, 500), (1280, 550), (0, 550) ]
    elif source == 'source/Jl. Brigjend Slamet Riadi Arah Barat.mkv':
        start_area = [(0, 200), (1280, 200), (1280, 250), (0, 250)]
        stop_area = [(0, 400), (1280, 400), (1280, 450), (0, 450) ]
    elif source == 'source/Jl. Ki Ageng Gribig Arah Utara.mkv':
        start_area = [(0, 200), (1280, 200), (1280, 250), (0, 250)]
        stop_area = [(0, 450), (1280, 450), (1280, 500), (0, 500)]
    elif source == 'source/Jl. Soekarno Hatta Arah Utara.mkv':
        start_area = [(0, 200), (1280, 200), (1280, 250), (0, 250)]
        stop_area = [(0, 350), (1280, 350), (1280, 400), (0, 400) ]
    elif source == 'source/Jl. Tlogomas Arah Timur.mkv':
        start_area = [(0, 200), (1280, 200), (1280, 250), (0, 250)]
        stop_area = [(0, 450), (1280, 450), (1280, 500), (0, 500)  ]
    else:
        print(source)
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                if len(tracked_dets)>0:
                    ...
                    draw_boxes(im0, bbox_xyxy, start_area, stop_area, weights, identities, categories, names)
            ...
            print("Vehicle Count = " + str(counting))
